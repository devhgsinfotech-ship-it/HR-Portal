    ...
    try {
      ...
      if (authUser) {
        ...
        if (profileImagePreview) {
          authUser.profilePhotoUrl = profileImagePreview; // Approximation, better to fetch again
        }
                      ...
                      <div>
                        ...
                        <div className="d-flex align-items-center flex-wrap row-gap-3 bg-light w-100 rounded p-3 mb-4">
                          <div className="d-flex align-items-center justify-content-center avatar avatar-xxl rounded-circle border border-dashed me-2 flex-shrink-0 text-dark frames">
                            {profileImagePreview ? (
                              <img src={profileImagePreview.startsWith('blob:') ? profileImagePreview : \`http://localhost:5000\${profileImagePreview}\`} alt="Profile" className="img-fluid rounded-circle" style={{width: '100%', height: '100%', objectFit: 'cover'}} />
                            ) : (
...
fs.writeFileSync('e:\\\\Vikramjeet\\\\hr-portal\\\\frontend\\\\src\\\\feature-module\\\\pages\\\\profile\\\\index.tsx', content);
