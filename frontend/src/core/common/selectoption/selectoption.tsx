...
export const Designation = [
  { value: "Select", label: "Select" },
  { value: "Junior Support Agent", label: "Junior Support Agent" },
...
export const First_Response_Time = [
  { value: "Select", label: "Select" },
  { value: "1 Hour", label: "1 Hour" },
...
export const Designation_Role = [
  ...
  { value: "Sales Executive Officer", label: "Sales Executive Officer" },
];
export const Reviewer = [
  { value: "Select", label: "Select" },
  { value: "William Parsons", label: "William Parsons" },
  { value: "Lucille Tomberlin", label: "Lucille Tomberlin" },
  { value: "Frederick Johnson", label: "Frederick Johnson" },
  { value: "Sarah Henry", label: "Sarah Henry" },
  { value: "Thomas Miller", label: "Thomas Miller" },
];
export const Project = [
  { value: "Select", label: "Select" },
...
export const Operator = [
  { value: "Select", label: "Select" },
  { value: "SLA Breach", label: "SLA Breach" },
  { value: "Status Based", label: "Category = Login Issue" },
  { value: "Priority Based", label: "Priority Based" },
  { value: "Time Based", label: "Time Based" },
];
export const Action_Type = [
  ...
  { value: "Close Ticketl", label: "Close Ticket" },
...
export const Employee_Name = [
  ...
  { value: "Stephan Peralt", label: "Stephan Peralt" },
  { value: "Thomas Bordelon", label: "Thomas Bordelon" },
];
export const Training_Type = [
  ...
  { value: "Nodejs Training", label: "Nodejs Training" },
  { value: "Django Training", label: "Django Training" },
];
export const Trainer_Name = [
  { value: "Select", label: "Select" },
  { value: "Harold Gaynor", label: "Harold Gaynor" },
  { value: "Sandra Ornellas", label: "Sandra Ornellas" },
  { value: "John Harris", label: "John Harris" },
  { value: "Whitney Barnette", label: "Whitney Barnette" },
  { value: "Richard Thompson", label: "Richard Thompson" },
];
...
export const modal_type = [
  { value: "Select", label: "Select" },
  { value: "AI Attendance Insights", label: "AI Attendance Insights" },
  { value: "AI Payroll Forecast", label: "AI Payroll Forecast" },
  { value: "AI Hiring Forecast", label: "AI Hiring Forecast" },
  {
    value: "AI Team Performance Insights",
    label: "AI Team Performance Insights",
  },
];
export const maximum_tokens = [
  { value: "Select", label: "Select" },
  { value: "256 Tokens", label: "256 Tokens" },
  { value: "512 Tokens", label: "512 Tokens" },
  { value: "1024 Tokens", label: "1024 Tokens" },
  { value: "2048 Tokens", label: "2048 Tokens" },
  { value: "3072 Tokens", label: "3072 Tokens" },
];
export const response_language = [
  ...
  { value: "German", label: "2048 Tokens" },
  { value: "Italian", label: "Italian" },
];
export const retrain_frequency = [
  { value: "Select", label: "Select" },
...
export const admin_dropdown = [
  ...
  { value: "Leave Manager", label: "Leave Manager" },
