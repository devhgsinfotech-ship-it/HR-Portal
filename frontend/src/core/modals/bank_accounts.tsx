            ...
            <div className="modal-body">
              <form >
                ...
                <div className="modal-btn">
                  ...
                  <button data-bs-dismiss="modal" type="submit" className="btn btn-primary">Save</button>
                </div>
              </form>
            </div>
          </div>
              ...
              <form>
                <div className="success-message text-center">
                  ...
                  <div className="col-lg-12 text-center modal-btn">
                    <button type="submit" className="btn btn-light" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" data-bs-dismiss="modal" className="btn btn-danger">Yes, Delete it</button>
                  </div>
                </div>
              </form>
            </div>
