...
import { Action_Type, Assign_To, Condition_Field, Operator, Rule_Name, Trigger_Event, Trigger_Time } from '@/core/common/selectoption/selectoption'
import React from 'react'
import { Link } from 'react-router'

const CampusHiringModal = () => {
  return (
   <>
  {/* Details */}
  <div
...
export default CampusHiringModal