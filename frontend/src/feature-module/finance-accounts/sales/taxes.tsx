...
const Taxes = () => {
    ...
    const data: TaxData[] = taxs_details;
    const columns = [
        {
            title: "Tax Name",
            dataIndex: "Tax_Name",
            render: (text: string, _record: TaxData) => (
                <div className="d-flex align-items-center">
                    <h6 className="fs-14 fw-medium text-gray-9 me-2">{text}</h6>
                    <button
                        type="button"
                        className="text-info btn btn-link p-0"
        ...
        },
        {
            ...
            sorter: (a: TaxData, b: TaxData) => a.Status.length - b.Status.length,
        },
        {
            title: "",
            dataIndex: "action",
            render: (_text: string, _record: TaxData) => (
            ...
            sorter: (a: TaxData, b: TaxData) => (a.action?.length || 0) - (b.action?.length || 0),
        },
    ];
