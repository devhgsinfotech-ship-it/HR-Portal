                            ...
                            <div className="card">
                                <div className="card-body">
                                    <div className="d-flex align-items-center justify-content-between mb-4">
                                        ...
                                        <button
                                            type="button"
                                            className="text-primary text-decoration-underline btn btn-link p-0"
                                    ...
                                    <div className="bg-light p-3 rounded mb-3">
                                        <div className="d-flex justify-content-between align-items-center mb-3">
                                            <h5>From</h5>
                                            <button type="button" className="text-dark fw-medium btn btn-link p-0">
                                            ...
                                            <div className="col-lg-3 col-md-6 col-sm-12">
                                                <div className="mb-3">
                                                    <div className="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <button
                                                            type="button"
                                                            className="text-primary fw-medium d-flex align-items-center btn btn-link p-0"
                                                            data-bs-toggle="modal"
                                    ...
                                    <div className="border-bottom mb-3">
                                        ...
                                        <div className="border rounded p-3 mb-3">
                                            ...
                                            <button
                                                type="button"
                                                className="text-primary add-more-description fw-medium d-flex align-items-center btn btn-link p-0"
                                            >
                                                <i className="ti ti-plus me-2" />
                                                Add New
                                            </button>
