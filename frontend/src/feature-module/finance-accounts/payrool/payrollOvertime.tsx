...
// Define a type for payroll overtime data
interface PayrollOvertimeData {
  Name: string;
  Rate: string;
  action?: string;
}
...
const PayRollOvertime = () => {
  const data: PayrollOvertimeData[] = payrollOvertime;
  const columns = [
    {
      title: "Name",
      dataIndex: "Name",
      ...
      sorter: (a: PayrollOvertimeData, b: PayrollOvertimeData) =>
    ...
    },
    {
      title: "",
      dataIndex: "action",
      render: (_text: string, _record: PayrollOvertimeData) => (
