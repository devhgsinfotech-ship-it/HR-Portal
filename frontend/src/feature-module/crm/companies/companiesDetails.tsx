                  ...
                  <div className="p-3">
                    ...
                    <div className="d-flex align-items-center mb-3">
                      <Link to="#" className="me-2">
                        <ImageWithBasePath src="assets/img/social/social-01.svg" alt="social" />
                      </Link>
                      <Link to="#" className="me-2">
                        <ImageWithBasePath src="assets/img/social/social-06.svg" alt="social" />
                      </Link>
                      <Link to="#" className="me-2">
                        <ImageWithBasePath src="assets/img/social/social-02.svg" alt="social" />
                      </Link>
                      <Link to="#" className="me-2">
                        <ImageWithBasePath src="assets/img/social/social-03.svg" alt="social" />
                      </Link>
                      <Link to="#" className="me-2">
                        <ImageWithBasePath src="assets/img/social/social-04.svg" alt="social" />
                      </Link>
                      <Link to="#" className="me-2">
                        <ImageWithBasePath src="assets/img/social/social-05.svg" alt="social" />
                      </Link>
                    </div>
