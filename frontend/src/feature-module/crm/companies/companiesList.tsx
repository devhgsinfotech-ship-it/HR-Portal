...

    {
      ...
      render: () => (
        <div className="action-icon d-inline-flex">
          <Link to={routes.companiesDetails} className="me-2" aria-label="View company details">
          ...
          <Link to="#" data-bs-toggle="modal" data-bs-target="#delete_modal" aria-label="Delete company">
