...
function ChartErrorFallback({ error, resetErrorBoundary }: { error: any, resetErrorBoundary: () => void }) {
  return (
            ...
            <div className="card">
              ...
              <div className="card-body pb-0">
                <div>
                  ...
                  <ErrorBoundary FallbackComponent={ChartErrorFallback} onReset={() => window.location.reload()}>
                    <ReactApexChart
                      options={dealsStage}
              ...
              <div className="card-body schedule-timeline activity-timeline">
                ...
                <div className="d-flex align-items-start">
                  ...
                  <div className="flex-fill ps-3 timeline-flow">
                    <p className="fw-medium text-gray-9 mb-1"><Link to={all_routes.activity} className="d-flex align-items-center">Meeting With <ImageWithBasePath src="assets/img/users/user-58.jpg" className="avatar avatar-sm rounded-circle mx-2" alt="avatar" />Abraham</Link></p>
                    <span>09:25 PM</span>
                  </div>
                </div>
              </div>
