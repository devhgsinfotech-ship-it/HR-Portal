                      ...
                      <div className="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
                        ...
                        >
                          <ImageWithBasePath
                            ...
                            alt="IntelliWave Solutions Logo"
                          />
                        </Link>
                        <div className="icons-social d-flex align-items-center">
                          <Link
                      ...
                      <div className="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
                        ...
                        >
                          <ImageWithBasePath
                            ...
                            alt="Chester Tech Solutions Logo"
                          />
                        </Link>
                        <div className="icons-social d-flex align-items-center">
                          <Link
                      ...
                      <div className="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
                        ...
                        >
                          <ImageWithBasePath
                            ...
                            alt="Charlotte Innovations Logo"
                          />
                        </Link>
                        <div className="icons-social d-flex align-items-center">
                          <Link
                    ...
                    <div className="card-body">
                      ...
                      <div className="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
                        ...
                        >
                          <ImageWithBasePath
                            src="assets/img/company/company-03.svg"
                            alt="Manchester Digital Ltd Logo"
                          />
                        </Link>
                        <div className="icons-social d-flex align-items-center">
                          <Link
