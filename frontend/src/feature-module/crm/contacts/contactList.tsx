        ...
        <div className="d-flex align-items-center file-name-icon">
          ...
          <div className="ms-2">
            <h6 className="fw-medium">
              <Link to={routes.contactDetails}>{text}</Link>
            </h6>
    ...
    },
    {
      ...
      render: () => (
        <ul className="contact-icon d-flex align-items-center ">
          <li>
            <Link to="#" className="p-1 rounded-circle contact-icon-mail d-flex align-items-center justify-content-center" aria-label="Mail">
          ...
          <li>
            <Link to="#" className="p-1 rounded-circle contact-icon-call d-flex align-items-center justify-content-center" aria-label="Call">
              <span className="d-flex align-items-center justify-content-center">
          ...
          <li>
            <Link to="#" className="p-1 rounded-circle contact-icon-msg d-flex align-items-center justify-content-center" aria-label="Message">
              <span className="d-flex align-items-center justify-content-center">
          ...
          <li>
            <Link to="#" className="p-1 rounded-circle contact-icon-skype d-flex align-items-center justify-content-center" aria-label="Skype">
              <span className="d-flex align-items-center justify-content-center">
          ...
          <li>
            <Link to="#" className="p-1 rounded-circle contact-icon-facebook d-flex align-items-center justify-content-center" aria-label="Facebook">
              <span className="d-flex align-items-center justify-content-center">
