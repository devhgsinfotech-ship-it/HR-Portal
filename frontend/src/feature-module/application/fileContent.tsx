  ...
  const columns = [
    {
      title: "Name",
      dataIndex: "name",
      render: (text: string, record: FileContentRow) => (
      ...
      sorter: (a: FileContentRow, b: FileContentRow) =>
            ...
            <div className="items">
              <div className="position-relative">
                <video
                  ...
                  crossOrigin=""
                  playsInline={true}
                  poster="/src/assets/img/file-manager/video1.jpg"
                >
                  <source
            ...
            <div className="items">
              <div className="position-relative">
                <video
                  ...
                  crossOrigin=""
                  playsInline={true}
                  poster="/src/assets/img/file-manager/video2.jpg"
                >
                  <source
                    src="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-720p.mp4"
                    type="video/mp4"
            ...
            <div className="items">
              <div className="position-relative">
                <video
                  ...
                  crossOrigin=""
                  playsInline={true}
                  poster="/src/assets/img/file-manager/video3.jpg"
                >
                  <source
                    src="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-720p.mp4"
                    type="video/mp4"
