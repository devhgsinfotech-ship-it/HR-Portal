                ...
                <PerfectScrollbar>
                  ...
                  <div className="sidebar-body chat-body" id="chatsidebar">
                    ...
                    <div className="chat-users-wrap">
                      ...
                      <div className="chat-list">
                        <Link to={all_routes.chart} className="chat-user-list">
                          <div className="avatar avatar-lg online me-2">
                            <ImageWithBasePath
                        ...
                        <div className="chat-content">
                          <div className="chat-info">
                            <div className="message-content">
                              ...
                              hybrid work model. Employees can work from home up
                        ...
                        <div className="chat-content">
                          <div className="chat-info">
                            <div className="message-content">
                              ...
                              hours. You’ll need to ensure you’re available
                              during your usual working hours and keep your
                              manager updated if anything changes.
                              <div className="emoj-group">
                                <ul>
                                  <li className="emoj-action">
                                    <Link
