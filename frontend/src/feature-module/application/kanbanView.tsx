    ...
    <>
      ...
      <div className="page-wrapper">
        <div className="content">
          <div className="d-flex my-xl-auto right-content justify-content-between align-items-center flex-wrap table-header">
