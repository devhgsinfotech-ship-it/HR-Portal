...
// Define a type-safe interface for roles permissions if not already defined
interface RolesPermissionsItem {
  roleName: string;
  createdOn: string;
}
...
const RolesPermissions = () => {
  ...
  const data: RolesPermissionsItem[] = rolesPermissionsData;
  const columns = [
    {
      title: "Role Name",
      dataIndex: "roleName",
      sorter: (a: RolesPermissionsItem, b: RolesPermissionsItem) =>
