                                    ...
                                    <div className="p-3">
                                        ...
                                        <div className="d-flex align-items-center">
                                            <Link to="to" className="me-2">
                                                <ImageWithBasePath src="assets/img/social/social-01.svg" alt="User Image" />
                                            </Link>
                                            <Link to="to" className="me-2">
                                                <ImageWithBasePath src="assets/img/social/social-06.svg" alt="User Image" />
                                            </Link>
                                            <Link to="to" className="me-2">
                                                <ImageWithBasePath src="assets/img/social/social-02.svg" alt="User Image" />
                                            </Link>
                                            <Link to="to" className="me-2">
                                                <ImageWithBasePath src="assets/img/social/social-03.svg" alt="User Image" />
                                            </Link>
                                            <Link to="to" className="me-2">
                                                <ImageWithBasePath src="assets/img/social/social-04.svg" alt="User Image" />
                                            </Link>
                                            <Link to="to" className="me-2">
                                                <ImageWithBasePath src="assets/img/social/social-05.svg" alt="User Image" />
                                            </Link>
                                        </div>
                                    </div>
                                </div>
