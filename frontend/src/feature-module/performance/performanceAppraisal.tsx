...
// Define interface for performance appraisal data
...
const PerformanceAppraisal = () => {
  ...
  const data: PerformanceAppraisalRecord[] = performanceAppraisalData;
  const columns: ColumnType<PerformanceAppraisalRecord>[] = [
    {
      title: "Name",
      dataIndex: "Name",
      render: (text: string, record?: PerformanceAppraisalRecord) => (
    ...
    },
    {
      ...
      sorter: (a, b) => a.AppraisalDate.length - b.AppraisalDate.length,
    },
    {
      title: "Status",
      dataIndex: "Status",
      ...
      render: () => (
        <div className="action-icon d-inline-flex">
          <Link
            ...
            aria-label="Edit Performance Appraisal"
          >
          ...
          <Link
            ...
            aria-label="Delete Performance Appraisal"
          >
