...
const PurchaseTransaction = () => {
  const data: PurchaseTransactionItem[] = purchase_transaction;
  const columns = [
    {
      title: "Invoice ID",
      dataIndex: "InvoiceID",
      render: (text: string, _record: PurchaseTransactionItem) => (
        <Link to="#" className="link-default">{text}</Link>
      ),
      sorter: (a: PurchaseTransactionItem, b: PurchaseTransactionItem) => a.InvoiceID.length - b.InvoiceID.length,
    },
    {
      title: "Customer",
      dataIndex: "CompanyName",
      render: (_text: string, record: PurchaseTransactionItem) => (
      ...
      sorter: (a: PurchaseTransactionItem, b: PurchaseTransactionItem) => a.CompanyName.length - b.CompanyName.length,
    },
    {
      title: "Email",
      dataIndex: "Email",
      sorter: (a: PurchaseTransactionItem, b: PurchaseTransactionItem) => a.Email.length - b.Email.length,
    },
    {
      title: "Created Date",
      dataIndex: "CreatedDate",
      sorter: (a: PurchaseTransactionItem, b: PurchaseTransactionItem) => a.CreatedDate.length - b.CreatedDate.length,
    },
    {
      title: "Amount",
      dataIndex: "Amount",
      sorter: (a: PurchaseTransactionItem, b: PurchaseTransactionItem) => a.Amount.length - b.Amount.length,
    },
    {
      title: "Payment Methode",
      dataIndex: "PaymentMethod",
      sorter: (a: PurchaseTransactionItem, b: PurchaseTransactionItem) => a.PaymentMethod.length - b.PaymentMethod.length,
    },
    {
      title: "Status",
      dataIndex: "Status",
      render: (text: PurchaseTransactionItem['Status'], _record: PurchaseTransactionItem) => (
        <Link
          to="#"
      ...
      sorter: (a: PurchaseTransactionItem, b: PurchaseTransactionItem) => a.Status.length - b.Status.length,
    },
    {
      title: "",
      dataIndex: "action",
