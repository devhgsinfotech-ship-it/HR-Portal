                    ...
                    <div>
                      ...
                      >
                        <ImageWithBasePath
                          ...
                          alt="Laptop Issue ticket avatar"
                        />
                      </Link>
                    </div>
                    <div className="dropdown">
                    ...
                    <div>
                      ...
                      >
                        <ImageWithBasePath
                          ...
                          className="img-fluid h-auto w-auto"
                          alt="Payment Issue ticket avatar"
                        />
                      </Link>
                    </div>
                    <div className="dropdown">
                    ...
                    <div>
                      ...
                      >
                        <ImageWithBasePath
                          ...
                          className="img-fluid h-auto w-auto"
                          alt="Access Denied ticket avatar"
                        />
                      </Link>
                    </div>
                    <div className="dropdown">
                    ...
                    <div>
                      ...
                      >
                        <ImageWithBasePath
                          ...
                          className="img-fluid h-auto w-auto"
                          alt="Display Glitch ticket avatar"
                        />
                      </Link>
                    </div>
                    <div className="dropdown">
                    ...
                    <div>
                      ...
                      >
                        <ImageWithBasePath
                          ...
                          className="img-fluid h-auto w-auto"
                          alt="Security Alert ticket avatar"
                        />
                      </Link>
                    </div>
                    <div className="dropdown">
                    ...
                    <div>
                      ...
                      >
                        <ImageWithBasePath
                          ...
                          className="img-fluid h-auto w-auto"
                          alt="Connectivity Issue ticket avatar"
                        />
                      </Link>
                    </div>
                    <div className="dropdown">
                    ...
                    <div>
                      ...
                      >
                        <ImageWithBasePath
                          ...
                          className="img-fluid h-auto w-auto"
                          alt="Update Error ticket avatar"
                        />
                      </Link>
                    </div>
                    <div className="dropdown">
                    ...
                    <div>
                      ...
                      >
                        <ImageWithBasePath
                          ...
                          className="img-fluid h-auto w-auto"
                          alt="Login Failure ticket avatar"
                        />
                      </Link>
                    </div>
                    <div className="dropdown">
                    ...
                    <div>
                      ...
                      >
                        <ImageWithBasePath
                          ...
                          className="img-fluid h-auto w-auto"
                          alt="Server Timeout ticket avatar"
                        />
                      </Link>
                    </div>
                    <div className="dropdown">
                    ...
                    <div>
                      ...
                      >
                        <ImageWithBasePath
                          ...
                          className="img-fluid h-auto w-auto"
                          alt="Email Client Setup ticket avatar"
                        />
                      </Link>
                    </div>
                    <div className="dropdown">
                    ...
                    <div>
                      ...
                      >
                        <ImageWithBasePath
                          ...
                          className="img-fluid h-auto w-auto"
                          alt="Application Crashing ticket avatar"
                        />
                      </Link>
                    </div>
                    <div className="dropdown">
