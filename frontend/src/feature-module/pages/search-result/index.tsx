                ...
                <div className="col-xl-2 col-md-4 col-6">
                  ...
                  >
                    <ImageWithBasePath
                      ...
                      className="rounded"
                      alt="SmartHR dashboard preview 1"
                    />
                  </Link>
                </div>
                <div className="col-xl-2 col-md-4 col-6">
                  ...
                  >
                    <ImageWithBasePath
                      ...
                      className="rounded"
                      alt="SmartHR dashboard preview 2"
                    />
                  </Link>
                </div>
                <div className="col-xl-2 col-md-4 col-6">
                  ...
                  >
                    <ImageWithBasePath
                      ...
                      className="rounded"
                      alt="SmartHR dashboard preview 3"
                    />
                  </Link>
                </div>
                <div className="col-xl-2 col-md-4 col-6">
                  ...
                  >
                    <ImageWithBasePath
                      ...
                      className="rounded"
                      alt="SmartHR dashboard preview 4"
                    />
                  </Link>
                </div>
                <div className="col-xl-2 col-md-4 col-6">
                  ...
                  >
                    <ImageWithBasePath
                      ...
                      className="rounded"
                      alt="SmartHR dashboard preview 5"
                    />
                  </Link>
                </div>
                <div className="col-xl-2 col-md-4 col-6">
                  ...
                  >
                    <ImageWithBasePath
                      ...
                      className="rounded"
                      alt="SmartHR dashboard preview 6"
                    />
                  </Link>
                </div>
                <div className="col-xl-2 col-md-4 col-6">
                  ...
                  >
                    <ImageWithBasePath
                      ...
                      className="rounded"
                      alt="SmartHR dashboard preview 7"
                    />
                  </Link>
                </div>
                <div className="col-xl-2 col-md-4 col-6">
                  ...
                  >
                    <ImageWithBasePath
                      ...
                      className="rounded"
                      alt="SmartHR dashboard preview 8"
                    />
                  </Link>
                </div>
                <div className="col-xl-2 col-md-4 col-6">
                  ...
                  >
                    <ImageWithBasePath
                      ...
                      className="rounded"
                      alt="SmartHR dashboard preview 9"
                    />
                  </Link>
                </div>
                <div className="col-xl-2 col-md-4 col-6">
                  ...
                  >
                    <ImageWithBasePath
                      ...
                      className="rounded"
                      alt="SmartHR dashboard preview 10"
                    />
                  </Link>
                </div>
                <div className="col-xl-2 col-md-4 col-6">
                  ...
                  >
                    <ImageWithBasePath
                      ...
                      className="rounded"
                      alt="SmartHR dashboard preview 11"
                    />
                  </Link>
                </div>
                <div className="col-xl-2 col-md-4 col-6">
                  ...
                  >
                    <ImageWithBasePath
                      ...
                      className="rounded"
                      alt="SmartHR dashboard preview 12"
                    />
                  </Link>
                </div>
              </div>
