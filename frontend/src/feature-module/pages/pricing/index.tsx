  ...
  const columns = [
    {
      title: "Plan",
      dataIndex: "plan",
      render: (text: string, _record: PricingRow) => (
        <h6 className="fw-medium">
          <Link to="#">{text}</Link>
        </h6>
      ),
      sorter: (a: PricingRow, b: PricingRow) => a.plan.length - b.plan.length,
    },
    {
      title: "Plan type",
      dataIndex: "plan_type",
      sorter: (a: PricingRow, b: PricingRow) =>
        a.plan_type.length - b.plan_type.length,
    },
    {
      title: "Created Date",
        ...
        <div className="content">
          ...
          <div className="card">
            ...
            <div className="card-body p-0">
              <Table<PricingRow> dataSource={data} columns={columns} />
            </div>
          </div>
          {/* /Pricing Table */}
        </div>
