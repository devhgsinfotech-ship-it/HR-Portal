...
// Define an interface for termination data
interface TerminationData {
  Resigning_Employee: string;
  Image: string;
  Department: string;
  ...
  const columns = [
    {
      ...
      sorter: (a: TerminationData, b: TerminationData) => a.Resigning_Employee.length - b.Resigning_Employee.length,
    },
    {
      title: "Department",
      dataIndex: "Department",
      sorter: (a: TerminationData, b: TerminationData) => a.Department.length - b.Department.length,
    },
    {
      title: "Termination Type",
      dataIndex: "Termination_Type",
      sorter: (a: TerminationData, b: TerminationData) => a.Termination_Type.length - b.Termination_Type.length,
    },
    {
      title: "Notice Date",
      dataIndex: "Notice_Date",
      sorter: (a: TerminationData, b: TerminationData) => a.Notice_Date.length - b.Notice_Date.length,
    },
    {
      title: "Reason",
      dataIndex: "Reason",
      sorter: (a: TerminationData, b: TerminationData) => a.Reason.length - b.Reason.length,
    },
    {
      title: "Resignation Date",
      dataIndex: "Resignation_Date",
      sorter: (a: TerminationData, b: TerminationData) => a.Resignation_Date.length - b.Resignation_Date.length,
    },
    {
      title: "",
      dataIndex: "actions",
