...
// Define an interface for policy details
...
const Policy = () => {
  ...
  const data: PolicyDetails[] = policy_details;
  const columns = [
    {
      title: "Name",
      dataIndex: "Name",
      render: (text: string, _record: PolicyDetails) => (
        <h6 className="fw-medium fs-14 text-dark">{text}</h6>
      ),
      sorter: (a: PolicyDetails, b: PolicyDetails) => a.Name.length - b.Name.length,
    },
    {
      title: "Department",
      dataIndex: "Department",
      sorter: (a: PolicyDetails, b: PolicyDetails) => a.Department.length - b.Department.length,
    },
    {
      title: "Description",
      dataIndex: "Description",
      sorter: (a: PolicyDetails, b: PolicyDetails) => a.Description.length - b.Description.length,
    },
    {
      title: "Created Date",
      dataIndex: "CreatedDate",
      sorter: (a: PolicyDetails, b: PolicyDetails) => a.CreatedDate.length - b.CreatedDate.length,
    },
    {
      title: "",
      dataIndex: "actions",
                        ...
                        <div className="policy-upload-bg mb-2 rounded-circle d-flex align-items-center justify-content-center bg-primary-transparent">
                          <span>
                            <ImageWithBasePath
                              ...
                              alt="Folder open icon for policy upload"
                              className="img-fluid"
                            />
                          </span>
                        </div>
