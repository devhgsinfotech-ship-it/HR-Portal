...
// Define an interface for promotion data
interface PromotionData {
    Promoted_Employee: string;
    Image: string;
    Department: string;
    ...
    const columns = [
        {
            ...
            sorter: (a: PromotionData, b: PromotionData) => a.Promoted_Employee.length - b.Promoted_Employee.length,
        },
        {
            title: "Department",
            dataIndex: "Department",
            sorter: (a: PromotionData, b: PromotionData) => a.Department.length - b.Department.length,
        },
        {
            title: "Designation From",
            dataIndex: "Designation_From",
            sorter: (a: PromotionData, b: PromotionData) => a.Designation_From.length - b.Designation_From.length,
        },
        {
            title: "Designation To",
            dataIndex: "Designation_To",
            sorter: (a: PromotionData, b: PromotionData) => a.Designation_To.length - b.Designation_To.length,
        },
        {
            title: "Promotion Date",
            dataIndex: "Promotion_Date",
            sorter: (a: PromotionData, b: PromotionData) => a.Promotion_Date.length - b.Promotion_Date.length,
        },
        {
            title: "",
            dataIndex: "actions",
