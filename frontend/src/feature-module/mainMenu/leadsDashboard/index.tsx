...
import RevenueIncomeChart from "./revenueIncomeChart";
                ...
                <div className="card-header">
                  <div className="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                    ...
                    <div className="dropdown">
                      <Link
                        to="#"
                        className="btn btn-white border-0 dropdown-toggle btn-md d-inline-flex align-items-center"
                        data-bs-toggle="dropdown"
                        aria-expanded="false"
                      >
                        Sales Pipeline
                      ...
                      <ul className="dropdown-menu dropdown-menu-end p-3">
                        <li>
                          <Link to="#" className="dropdown-item rounded-1">Marketing Pipeline</Link>
                        </li>
                        <li>
                          <Link to="#" className="dropdown-item rounded-1">Sales Pipeline</Link>
                        </li>
                        <li>
              ...
              <div className="card flex-fill">
                <div className="card-header">
                  <div className="d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                    ...
                    <div>
                      <Link to="#" className="btn btn-light btn-md px-3">
                        View All
                      </Link>
                    </div>
                  </div>
                ...
                <div className="card-body">
                  <div className="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <div className="d-flex align-items-center">
                      <Link to="#" className="btn btn-light btn-icon btn-md">
              ...
              <div className="card flex-fill">
                <div className="card-header">
                  <div className="d-flex align-items-center justify-content-between flex-wrap">
                    ...
                    <div>
                      <Link to={all_routes.activity} className="btn btn-md btn-light px-3">
                        View All
                      </Link>
                    </div>
                  </div>
                ...
                <div className="card-body schedule-timeline activity-timeline">
                  ...
                  <div className="d-flex align-items-start">
                    ...
                    <div className="flex-fill ps-3 pb-4 timeline-flow">
                      <p className="fw-medium text-gray-9 mb-1">
                        <Link to={all_routes.activity}>You sent 1 Message to the James.</Link>
                      </p>
                      <span>10:25 PM</span>
                    </div>
                  </div>
                    ...
                    <div className="col-xxl-5 col-sm-6">
                      <div className="pe-3 border-end">
                        <div className="d-flex align-items-center mb-4">
                          ...
                          <div className="ms-2">
                            <h6 className="fw-medium text-truncate mb-1">
                              <Link to={all_routes.countries}>Singapore</Link>
                            </h6>
                        ...
                        <div className="d-flex align-items-center mb-4">
                          ...
                          <div className="ms-2">
                            <h6 className="fw-medium text-truncate mb-1">
                              <Link to={all_routes.countries}>France</Link>
                            </h6>
                        ...
                        <div className="d-flex align-items-center mb-4">
                          ...
                          <div className="ms-2">
                            <h6 className="fw-medium text-truncate mb-1">
                              <Link to={all_routes.countries}>Norway</Link>
                            </h6>
                        ...
                        <div className="d-flex align-items-center mb-4">
                          ...
                          <div className="ms-2">
                            <h6 className="fw-medium text-truncate mb-1">
                              <Link to={all_routes.countries}>USA</Link>
                            </h6>
                        ...
                        <div className="d-flex align-items-center">
                          ...
                          <div className="ms-2">
                            <h6 className="fw-medium text-truncate mb-1">
                              <Link to={all_routes.countries}>UAE</Link>
                            </h6>
                            <span className="fs-13 text-truncate">Leads : 221</span>
                          </div>
                        </div>
            ...
            <div className="col-xl-7 d-flex">
              <div className="card flex-fill">
                <div className="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-2">
                  ...
                  <div className="d-flex align-items-center">
                    <div>
                      <Link to={all_routes.leadsList} className="btn btn-md btn-light px-3">
                        View All
                      </Link>
                    </div>
                  </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="d-flex align-items-center file-name-icon">
                              ...
                              <div className="ms-2">
                                <h6 className="fw-medium">
                                  <Link to={all_routes.companiesDetails}>Quantum Nexus</Link>
                                </h6>
                              </div>
                            </div>
                          </td>
