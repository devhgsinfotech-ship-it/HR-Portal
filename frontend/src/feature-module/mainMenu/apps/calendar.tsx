    ...
    <ErrorBoundary fallback={<div>Failed to load calendar. Please refresh the page.</div>}>
                    ...
                    <div className="bg-dark rounded text-center position-relative p-4">
                      ...
                      <div className="box-bg">
                        <span className="bg-right">
                          <ImageWithBasePath src="assets/img/bg/email-bg-01.png" alt="Decorative email background right" />
                        </span>
                        <span className="bg-left">
                          <ImageWithBasePath src="assets/img/bg/email-bg-02.png" alt="Decorative email background left" />
                        </span>
                      </div>
                    </div>
                    {/* /Upgrade Details */}
      ...
      <Modal show={showEventDetailsModal} onHide={handleEventDetailsClose}>
        ...
        <div className="modal-body">
          <p className="d-flex align-items-center fw-medium text-dark mb-3">
          ...
          <p className="d-flex align-items-center fw-medium text-dark mb-0">
