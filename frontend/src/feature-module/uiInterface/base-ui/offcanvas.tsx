        ...
        <div className="card">
          ...
          <div className="card-body">
            <p>
              ...
              <code>.text-bg-dark</code> to the
              <code>.offcanvas</code> and <code>.btn-close-white</code> to{" "}
              <code>.btn-close</code>
              for proper styling with a dark offcanvas. If you have dropdowns
              within, consider also adding <code>
                .dropdown-menu-dark
              </code> to <code>.dropdown-menu</code>.
            </p>
            <div>
              <button
                className="btn btn-primary mt-2 mt-md-0"
