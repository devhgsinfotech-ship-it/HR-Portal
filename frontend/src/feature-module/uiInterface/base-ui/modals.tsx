        ...
        <div className="card">
          ...
          <div className="card-body">
            <p className="text-muted">
              ...
              bottom, or center of page by specifying classes{" "}
                ...
                <div className="modal-content">
                  <div className="modal-body">
                    <div className="auth-brand text-center mt-2 mb-3 position-relative top-0">
                      <Link to={all_routes.adminDashboard} className="logo-dark">
                        <span>
                          <ImageWithBasePath src="assets/img/logo.svg" alt="dark logo" />
                        </span>
                      </Link>
                      <Link to={all_routes.adminDashboard} className="logo-light">
                        <span>
                ...
                <div className="modal-content modal-filled bg-success">
                  <div className="modal-body p-4">
                    <div className="text-center">
                      ...
                      <p className="mt-3">
                        Congratulations! You've achieved success! 🎉 Your hard
                        work, dedication, and perseverance have paid off. Keep
                        up the great work and continue to strive for excellence.
                      </p>
                      <button
                        type="button"
                  ...
                  <div className="modal-body p-4">
                    <div className="text-center">
                      ...
                      <p className="mt-3">
                        ...
                        scheduled maintenance on 21 April from 10:30 PM to 11:45
                        PM.
                      </p>
                      <button
                        type="button"
                ...
                <div className="modal-content">
                  <div className="modal-body p-4">
                    <div className="text-center">
                      ...
                      <p className="mt-3">
                        We have detected suspicious activity on our platform. As
                        a precautionary measure, we urge all users to refrain
                        from logging in or providing any personal information
                ...
                <div className="modal-content modal-filled bg-danger">
                  <div className="modal-body p-4">
                    <div className="text-center">
                      ...
                      <p className="mt-3">
                        A critical security breach has been identified on our
                        platform. Your personal information and sensitive data
                        may be at risk.
                      </p>
                      <button
                        type="button"
    ...
    <div className="row">
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            >
              <div className="modal-dialog">
                <div className="modal-content">
                  <div className="modal-header text-bg-primary border-0 rounded">
            ...
            >
              <div className="modal-dialog">
                <div className="modal-content">
                  <div className="modal-header text-bg-success border-0 rounded">
      ...
      <div className="col-xl-6">
        <div className="card">
          ...
          <div className="card-body">
            <p className="text-muted">
              Modal with header, body and footer having contexual background
              color.
            </p>
        ...
        <div className="card">
          ...
          <div className="card-body">
            <p className="text-muted">
              ...
              slightly different contents? Use <code>event.relatedTarget</code>{" "}
              and{" "}
              <Link
          ...
          <div className="card-body">
            ...
            >
              <div className="modal-dialog">
                <div className="modal-content">
                  <div className="modal-header">
                    <h1 className="modal-title" id="exampleModalPopoversLabel">
                      Modal title
                    </h1>
                    <button
                      type="button"
